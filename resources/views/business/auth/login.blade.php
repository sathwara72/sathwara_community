...
@section('content')
    <section class="py-4 md:py-6 bg-slate-50/70 flex-1 flex items-center justify-center">
        <div class="max-w-sm w-full px-4 mx-auto">
            ...
            <div
                class="bg-white p-5 md:p-6 rounded-2xl border border-slate-200/80 shadow-lg relative overflow-hidden space-y-3">
                ...
                <div class="text-center space-y-1">
                    <div
                        class="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-primary-50 border border-primary-100 text-primary-600 shadow-2xs mx-auto">
                    ...
                    <div class="flex items-center justify-center gap-1.5 flex-wrap pt-0.5">
                        <span
                            class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-slate-50 border border-slate-200/80 text-[10px] font-bold text-slate-600">
                ...
                @if(session('success'))
                    <div
                        class="p-2.5 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 flex items-center gap-2 text-xs font-semibold">
                ...
                @if($errors->any())
                    <div
                        class="p-2.5 rounded-xl bg-rose-50 border border-rose-200 text-rose-800 flex items-start gap-2 text-xs font-semibold">
                ...
                <!-- Login Form -->
                <form method="POST" action="{{ route('business.login.submit') }}" class="space-y-2.5 pt-0.5"
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            ...
                            <input id="login" type="text" name="login" value="{{ old('login') }}" required autofocus
                                autocomplete="username" placeholder="{{ __('Enter your email or phone number') }}"
                        ...
                        <div class="relative">
                            ...
                            <button type="button" @click="showPassword = !showPassword"
                                ...
                                <svg x-show="showPassword" class="w-3.5 h-3.5" fill="none" stroke="currentColor"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858-5.908a10.018 10.018 0 013.682-.863c4.478 0 8.268 2.943 9.542 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21M3 3l18 18" />
                                </svg>
                            </button>
                        </div>
                ...
                <div class="pt-2.5 border-t border-slate-100 text-center space-y-1">
                    <p class="text-[11px] text-slate-500 font-medium">
                        ...
                        <a href="{{ route('register.business') }}"
                            class="font-bold text-primary-600 hover:text-primary-700 hover:underline ml-0.5">
                            {{ __('Register your Business') }} &rarr;
                        </a>
                    </p>
                    <div>
                        <a href="{{ route('business.directory') }}"
                            class="inline-flex items-center gap-1 text-[11px] font-semibold text-slate-400 hover:text-slate-600 transition-colors">
